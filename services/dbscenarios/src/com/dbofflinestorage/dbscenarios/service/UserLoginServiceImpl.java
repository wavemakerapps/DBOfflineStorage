...
public class UserLoginServiceImpl implements UserLoginService {
    ...
    @Override
    public UserLogin getById(Short userloginId) {
    ...
    @Transactional(readOnly = true, value = "dbscenariosTransactionManager")
    @Override
    public List<UserLogin> findByMultipleIds(List<Short> userloginIds, boolean orderedReturn) {
    ...
    @Transactional(value = "dbscenariosTransactionManager")
    @Override
    public UserLogin delete(Short userloginId) {
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service dbscenarios for table UserLogin to {} format", options.getExportType());
