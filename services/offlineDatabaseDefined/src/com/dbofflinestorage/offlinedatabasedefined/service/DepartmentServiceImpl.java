...
import com.dbofflinestorage.offlinedatabasedefined.Department;
 ...
 * @see Department
 */
@Service("offlineDatabaseDefined.DepartmentService")
@Validated
public class DepartmentServiceImpl implements DepartmentService {
    ...
    @Lazy
    @Autowired
    @Qualifier("offlineDatabaseDefined.EmployeeService")
    private EmployeeService employeeService;

    @Autowired
    @Qualifier("offlineDatabaseDefined.DepartmentDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service offlineDatabaseDefined for table Department to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service offlineDatabaseDefined for table Department to {} format", options.getExportType());
