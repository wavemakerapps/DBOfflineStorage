...
import com.dbofflinestorage.offlinedatabasedefined.service.DepartmentService;
 ...
 * @see Department
 */
@RestController("offlineDatabaseDefined.DepartmentController")
@Api(value = "DepartmentController", description = "Exposes APIs to work with Department resource.")
@RequestMapping("/offlineDatabaseDefined/Department")
public class DepartmentController {

    private static final Logger LOGGER = LoggerFactory.getLogger(DepartmentController.class);

    @Autowired
	@Qualifier("offlineDatabaseDefined.DepartmentService")
