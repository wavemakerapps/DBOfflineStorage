...
import com.dbofflinestorage.offlinedatabasedefined.service.EmployeeService;
 ...
 * @see Employee
 */
@RestController("offlineDatabaseDefined.EmployeeController")
@Api(value = "EmployeeController", description = "Exposes APIs to work with Employee resource.")
@RequestMapping("/offlineDatabaseDefined/Employee")
public class EmployeeController {
    ...
    @WMAccessVisibility(value = AccessSpecifier.APP_ONLY)
    public Employee getByUniqueColumn(@PathVariable("uniqueColumn") String uniqueColumn) {
        LOGGER.debug("Getting Employee with uniques key UniqueColumn");
        return employeeService.getByUniqueColumn(uniqueColumn);
    }
