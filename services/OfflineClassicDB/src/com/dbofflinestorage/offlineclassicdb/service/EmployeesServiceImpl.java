 ...
 * @see Employees
 */
@Service("OfflineClassicDB.EmployeesService")
@Validated
public class EmployeesServiceImpl implements EmployeesService {
    ...
    @Lazy
    @Autowired
    @Qualifier("OfflineClassicDB.CustomersService")
    private CustomersService customersService;

    @Autowired
    @Qualifier("OfflineClassicDB.EmployeesDao")
    ...
    public Downloadable export(ExportType exportType, String query, Pageable pageable) {
        LOGGER.debug("exporting data in the service OfflineClassicDB for table Employees to {} format", exportType);
    ...
    public void export(DataExportOptions options, Pageable pageable, OutputStream outputStream) {
        LOGGER.debug("exporting data in the service OfflineClassicDB for table Employees to {} format", options.getExportType());
