...
import com.dbofflinestorage.offlineclassicdb.service.AllTypesService;
...
public class AllTypesController {
    ...
    public AllTypes editAllTypes(@PathVariable("id") Integer id, MultipartHttpServletRequest multipartHttpServletRequest) {
        AllTypes newAllTypes = WMMultipartUtils.toObject(multipartHttpServletRequest, AllTypes.class, "OfflineClassicDB");
