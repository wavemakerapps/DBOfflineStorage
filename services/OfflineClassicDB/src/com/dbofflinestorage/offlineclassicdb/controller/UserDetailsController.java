...
import com.dbofflinestorage.offlineclassicdb.service.UserDetailsService;
 ...
 * @see UserDetails
 */
@RestController("OfflineClassicDB.UserDetailsController")
@Api(value = "UserDetailsController", description = "Exposes APIs to work with UserDetails resource.")
@RequestMapping("/OfflineClassicDB/UserDetails")
public class UserDetailsController {

    private static final Logger LOGGER = LoggerFactory.getLogger(UserDetailsController.class);

    @Autowired
	@Qualifier("OfflineClassicDB.UserDetailsService")
