...
import com.dbofflinestorage.offlineclassicdb.service.CustomersService;
 ...
 * @see Customers
 */
@RestController("OfflineClassicDB.CustomersController")
@Api(value = "CustomersController", description = "Exposes APIs to work with Customers resource.")
@RequestMapping("/OfflineClassicDB/Customers")
