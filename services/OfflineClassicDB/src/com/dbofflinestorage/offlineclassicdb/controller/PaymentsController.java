...
import com.dbofflinestorage.offlineclassicdb.service.PaymentsService;
 ...
 * @see Payments
 */
@RestController("OfflineClassicDB.PaymentsController")
@Api(value = "PaymentsController", description = "Exposes APIs to work with Payments resource.")
@RequestMapping("/OfflineClassicDB/Payments")
