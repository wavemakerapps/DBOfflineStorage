...
import com.dbofflinestorage.offlineclassicdb.service.OrdersService;
 ...
 * @see Orders
 */
@RestController("OfflineClassicDB.OrdersController")
@Api(value = "OrdersController", description = "Exposes APIs to work with Orders resource.")
@RequestMapping("/OfflineClassicDB/Orders")
